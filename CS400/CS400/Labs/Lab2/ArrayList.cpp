...
void ArrayList::push_back(int elem)
{
	add(elem);
}
...
void ArrayList::set(int index, int elem)
{
	if (index >= _size || index < 0)
	{
...
void ArrayList::add(int index, int elem)
{
	if (index > _size || index < 0)
	{
