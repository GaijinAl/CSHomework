...
void LinkedList::traverse(Node* head)
{
...
void LinkedList::add_head_1(NodePtr& head, dataType num)
{
...
void LinkedList::add_head_1_5(Node*& head, dataType num)
{
	Node* temp = new Node(num);
	temp->next = head;
	head = temp;
...
void LinkedList::add_head_2(Node** head, dataType num)
{
	Node* temp = new Node(num);
	temp->next = *head;
	*head = temp;
...
void LinkedList::add_tail(NodePtr& head, dataType num)
{
	if (head == nullptr)
	{
		add_head_1(head, num);
...
Node* LinkedList::search(NodePtr& head, dataType num)
{
	NodePtr curr = head;
...
void LinkedList::del(NodePtr& head, dataType num)
{
	// Case1: List is empty
